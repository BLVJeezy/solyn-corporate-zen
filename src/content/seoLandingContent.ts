...
export const seoLandingContent: Record<"nl" | "fr" | "en", SeoLandingContent> = {
  nl: {
    ...
    trustLine: "Vertrouwd door Limburgse KMO's — van loodgieters tot medische groothandel",
    trustBadges: ["GDPR-conform", "Geleverd in 7-14 dagen", "100% eigen code & domein", "Gevestigd in Limburg"],
    stats: [
      { value: "7-14", label: "Dagen opleverduur" },
      { value: "Op maat", label: "Prijs per project" },
      { value: "100%", label: "Eigen code & domein" },
      { value: "1-op-1", label: "Rechtstreeks contact" },
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Ja. Voor een vast maandbedrag verzorgen we hosting, updates, security, kleine aanpassingen en doorlopende SEO-content. U kunt maandelijks opzeggen.",
      },
    ],
  ...
  fr: {
    ...
    trustLine: "La confiance de PME belges — artisans, commerces et B2B",
    trustBadges: ["Conforme RGPD", "Livré en 7-14 jours", "100% propriétaire de votre code", "Basé au Limbourg"],
    stats: [
      { value: "7-14", label: "Jours de livraison" },
      { value: "Sur mesure", label: "Prix par projet" },
      { value: "100%", label: "Votre code & domaine" },
      { value: "1-à-1", label: "Contact direct" },
    ],
    ...
    faq: [
      ...
      { q: "Proposez-vous maintenance et hébergement ?", a: "Oui. Pour un montant mensuel fixe, nous gérons l'hébergement, les mises à jour, la sécurité, les petites modifications et le contenu SEO continu. Résiliable mensuellement." },
    ],
  ...
  en: {
    ...
    trustLine: "Trusted by Belgian SMEs — from trade businesses to medical wholesale",
    trustBadges: ["GDPR-compliant", "Shipped in 7-14 days", "You own 100% of your code", "Based in Limburg, Belgium"],
    stats: [
      { value: "7-14", label: "Days to delivery" },
      { value: "Custom", label: "Price per project" },
      { value: "100%", label: "Your code & domain" },
    ...
    faq: [
      ...
      { q: "Do you offer maintenance and hosting?", a: "Yes. For a fixed monthly fee we handle hosting, updates, security, small tweaks and ongoing SEO content. Cancel any time." },
    ],
