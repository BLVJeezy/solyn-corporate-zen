    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-20 md:pt-28 pb-12 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            Echte ondernemers. <span className="bg-gradient-to-r from-[hsl(40_48%_56%)] to-[hsl(210_15%_70%)] bg-clip-text text-transparent">Echte resultaten.</span>
          </motion.h1>
          ...
          >
            Hieronder zie je concreet wat we voor andere ondernemers hebben gebouwd — en welke resultaten dat opleverde.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight mb-4">
              Klaar voor jouw <span className="bg-gradient-to-r from-[hsl(40_48%_56%)] to-[hsl(210_15%_70%)] bg-clip-text text-transparent">resultaat</span>?
            </h2>
            <p className="text-white/60 text-base md:text-lg max-w-xl mx-auto">
              Dit zijn slechts enkele voorbeelden van wat we hebben gerealiseerd. Met elke ondernemer bouwen we op maat — afgestemd op het doel.
            </p>
          </motion.div>
        </div>
      </section>
