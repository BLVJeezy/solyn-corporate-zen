...
export const translations: Record<Lang, Record<string, string>> = {
  NL: {
    ...
    "pricing.growth.desc": "Uw website blijft groeien, ook na de lancering.",
    "pricing.growth.f1": "Dagelijks verse AI-blogcontent",
    "pricing.growth.f2": "Nieuwe features op aanvraag",
    "pricing.growth.f3": "Proactieve bugfixes & updates",
    "pricing.growth.f4": "SEO-optimalisatie & snelheid",
  ...
  FR: {
    ...
    "pricing.growth.desc": "Votre site continue de croître après le lancement.",
    "pricing.growth.f1": "Contenu blog IA quotidien",
    "pricing.growth.f2": "Nouvelles fonctionnalités sur demande",
    "pricing.growth.f3": "Corrections proactives & mises à jour",
    "pricing.growth.f4": "Optimisation SEO & vitesse",
  ...
  EN: {
    ...
    "pricing.growth.desc": "Your website keeps growing after launch.",
    "pricing.growth.f1": "Daily fresh AI blog content",
    "pricing.growth.f2": "New features on demand",
    "pricing.growth.f3": "Proactive bug fixes & updates",
    "pricing.growth.f4": "SEO optimization & speed",
