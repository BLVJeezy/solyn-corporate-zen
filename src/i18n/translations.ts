...
export const translations: Record<Lang, Record<string, string>> = {
  NL: {
    ...
    "pricing.mvp.longDesc": "Voor founders of teams die snel willen schakelen — strategie, design en ontwikkeling in 14 dagen.",
    "pricing.pauseCancel": "Pauzeer of annuleer op elk moment",
    "pricing.whatsIncluded": "Wat zit erin:",
    ...
    "pricing.diamond.longDesc": "In 2 weken heb je een volledig werkend product klaar om te lanceren.",
  ...
  FR: {
    ...
    "pricing.mvp.longDesc": "Pour les fondateurs ou équipes qui veulent avancer vite — stratégie, design et développement en 14 jours.",
    "pricing.pauseCancel": "Pausez ou annulez à tout moment",
    ...
    "pricing.diamond.longDesc": "En 2 semaines, vous aurez un produit entièrement fonctionnel prêt à être lancé.",
  ...
  EN: {
    ...
    "pricing.mvp.longDesc": "For founders or teams who want to move fast — strategy, design, and development executed in 14 days.",
    "pricing.pauseCancel": "Pause or cancel anytime",
    ...
    "pricing.diamond.longDesc": "In 2 weeks you'll have a full working product ready to launch to the world.",
