...
const services = [
  {
    icon: Code,
    title: "Development",
    description: "Op maat gemaakte web- en softwareoplossingen die uw digitale visie tot leven brengen met moderne technologieën.",
  },
  {
    icon: Building2,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Van sourcing tot infrastructuur — wij bieden complete oplossingen voor uw onderneming.
          </p>
        </motion.div>
